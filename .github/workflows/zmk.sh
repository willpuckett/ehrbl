...
for i in $(seq 0 $((--length))); do 
    ...
    build+=(-DZMK_CONFIG=$home/Public/ehrbl/config)
...
# west build -d build/left -b seeeduino_xiao_ble -S studio-rpc-usb-uart -- -DSHIELD=ehrbl_left -DZMK_CONFIG=$home/Public/ehrbl/config -DDTS_EXTRA_CPPFLAGS="-DLAYOUT=3;-DDIRECT" -DZMK_EXTRA_MODULES="$home/Public/zmk-auto-layer;$home/Public/zmk-helpers;$home/Public/zmk-antecedent-morph"